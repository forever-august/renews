...
async fn test_add_user_with_pgp_key() {
    ...
    auth.add_user_with_key("testuser", "testpass", Some("test-pgp-key"))
        .await
        .unwrap();
...
async fn test_add_user_without_pgp_key() {
    ...
    auth.add_user_with_key("testuser", "testpass", None)
        .await
        .unwrap();
...
async fn test_set_group_moderated() {
    ...
    // Set as moderated
    storage
        .set_group_moderated("test.group", true)
        .await
        .unwrap();
    ...
    storage
        .set_group_moderated("test.group", false)
        .await
        .unwrap();
